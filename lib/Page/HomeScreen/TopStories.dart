...
class _TopStoriesState extends State<TopStories> {
  ...
  Widget build(BuildContext context) {
    ...
    String updatedDt = newFormat.format(dt);
      final String apiUrl ="https://newsapi.org/v2/top-headlines?apiKey=279ff2d9334747f980557d5520f7a04f&from=$updatedDt&sortBy=popularity&language=en&sources=techcrunch,CNN,bbc-news";
